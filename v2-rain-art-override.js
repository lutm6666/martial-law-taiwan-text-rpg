...
var PRIMARY='assets/v2/rain-house-front.jpg?v=1';
var FALLBACK='assets/v2/rain-house-front.svg?v=1';

function patchImage(img){
  if(!img||img.dataset.v2RainArtPatched==='1')return;
  var src=img.getAttribute('src')||'';
  var alt=img.getAttribute('alt')||'';
  if(src.indexOf('rain-ch1-concept.webp')===-1&&alt.indexOf('雨夜中的林宅')===-1)return;
