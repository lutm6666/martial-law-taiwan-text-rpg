...
function showRoot(){mount();hideBase();$('case2Screen').classList.remove('hidden');$('caseChip').textContent='CASE 02・秋月的條件';var build=document.querySelector('.build');if(build)build.textContent='BUILD 5.1.3・CASE 02'}
