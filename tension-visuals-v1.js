...
const obs=new MutationObserver(()=>{mount();pressure()});addEventListener('DOMContentLoaded',()=>{mount();pressure();const g=document.getElementById('gameScreen');if(g)obs.observe(g,{subtree:true,childList:true,characterData:true})});
})();