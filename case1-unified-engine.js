...
var visualMeta={
 tea:{alt:'1958 年臺北茶行・傍晚',before:'桌上的冊子攤在冷掉的茶旁，先看看缺頁留下了什麼。',after:'17、21、22 頁不見了；紙根上的斜裂方向相近，21、22 頁的位置留下較寬的一段缺口。',observed:['你把冊子拉近。紙邊受過潮，翻動時有很輕的脆響；第 17、21、22 頁只剩貼著線裝處的窄紙根。','第 17 頁的裂口斜向右下，21、22 頁留下的破口也沿著近似方向延伸。阿川用鉛筆標過頁碼，沒有重新補寫。']},
 print:{alt:'1958 年臺北印刷行・午後',before:'機器剛停，油墨味還沒散。看看工作桌、紙堆和後間。',after:'帳簿、鉛字盒與紙堆各有位置；後間少了一捆紙，地上還留著拖動竹籃的細痕。',observed:['你沿著排字桌走了一圈。鉛字盒靠牆排開，借物簿壓在一塊玻璃下，後間則堆著裁下的紙邊與待處理廢紙。','最靠門的一疊中間空了一捆，麻繩頭垂在竹籃旁。地上的紙屑被拖出一道弧線，一直到後門。']},
 market:{alt:'1958 年臺北市場・白天',before:'紙在市場裡有第二次用途。先看看攤位怎麼拿紙、紙又被丟到哪裡。',after:'墊箱、包貨、擦手的紙混在一起；有些帶字，有些已被油與泥水蓋過。',observed:['你順著攤位慢慢走。舊報紙墊在菜籃底，印過字的白紙被折成小包，幾張沾了花生油的紙壓在秤盤旁。','紙到了這裡，很快就失去原本的用途。有人只看乾不乾淨，有人只看夠不夠厚，沒有人特別問它從哪一家店來。']},
 bookstall:{alt:'1958 年臺北舊書攤・下午',before:'騎樓裡的書堆有些鼓得不自然。看看頁縫、書脊和老闆手邊那疊舊紙。',after:'幾本工具書夾著散紙，櫃檯旁也有一疊被留下來的紙張；其中一本舊字典中段特別厚。',observed:['你蹲到書架前。灰塵一動就往光裡浮，幾本工具書的書頁間露出紙角，像有人把零散紙張隨手夾進去。','最下層那本舊字典中段比前後厚了一截。老闆看見你盯著它，只說：「那孩子拿來的紙，我沒全丟。」']}
};
...
var evidence={
 ...
 postal_stub:{name:'錯投郵件存根',type:'存根',desc:'郵務人員當天處理的是另一條巷子的錯投郵件；存根記著不同地址與收件人。'},
...
var locations={
 ...
 print:{name:'印刷行',sub:'油墨與紙堆',intro:['最後一聲鉛字碰撞剛停，店裡還浮著油墨、紙灰與熱機器混在一起的味道。周老闆正把鉛字歸回格子，你一進門，他先看見你手裡的冊子。','「阿川叫你來的？」他擦了擦手，語氣很平，動作卻慢了一拍。後間堆著待處理的紙捆，門邊竹籃上還掛著一截沒收好的麻繩。'],actions:['print_ledger','print_zhou','print_waste']},
 ...
 bookstall:{name:'舊書攤',sub:'紙頁之間',intro:['騎樓深處比街上暗一截。書架從地面一路疊到肩高，舊紙受潮後特有的氣味混著樟腦味。','老闆正把幾張散紙壓進一本工具書，見你提到跑腿少年，只抬了抬下巴：「他昨天是拿過一捆東西來。」'],actions:['book_owner','book_search','book_stub','book_pages']}
};
...
var actions={
 ...
 market_postman:{label:'問清「穿制服的人」',hint:'把每個人真正看見的部分分開',run:function(){state.flags.postmanRumor=true;return{lines:['魚販只記得那人穿郵務制服；隔壁攤主記得他拿著一張紙問巷名；到了第三個人口中，已經變成「那個郵差在找阿川丟掉的東西」。','你請三個人各自重說一次，不替前一個人補細節。留下來的共同部分其實很少：郵務制服、問地址、昨天午後。舊書攤離這裡不遠，也許有人留著當天的郵件紙據。']}}},
 ...
 book_stub:{label:'核對櫃檯下的郵件存根',hint:'看看昨天的郵務人員留下了什麼',run:function(){gain('postal_stub');return{lines:[state.flags.postmanRumor?'老闆聽你提到那名郵務人員，彎腰從櫃檯下抽出一張存根：「你說的是不是這個？昨天他來問過。」':'你在櫃檯下看見一張折過的郵件存根。老闆說，昨天確實有郵務人員拿著它來問過路。','存根上的地址在另一條巷子，收件人姓陳。日期正是昨天。市場裡那段越傳越大的話，到這張小小的紙上忽然縮回了一件很普通的錯投郵件。']}}},
