...
var evidence={
 ...
 postal_stub:{name:'問路地址便條',type:'便條',desc:'舊書攤留下的地址便條寫著「陳先生」與另一條巷子的門牌；老闆記得郵務人員前一天下午就是拿著這個地址來問路。'},
...
var deduction=[
 ...
 {q:'第三問：市場裡那名郵務人員當天在做什麼？',opts:[['tracker','他在追查阿川的筆記'],['rumor','攤販都這麼說，所以他應該與失頁有關'],['postal','他在處理一封錯投到別巷的郵件']],correct:'postal',need:'postal_stub',teach:'把市場裡的轉述和便條上的姓氏、巷址放在一起。'},
...
var actions={
 ...
 book_stub:{label:'查看櫃檯下的地址便條',hint:'看看昨天那名郵務人員問的是哪個地址',run:function(){gain('postal_stub');return{lines:[state.flags.postmanRumor?'老闆聽你提到那名郵務人員，彎腰從櫃檯下抽出一張折過的小紙片：「他昨天拿著這個地址來問路，走的時候落在這裡。」':'你在櫃檯下看見一張折過的小紙片。老闆想了想，說昨天確實有郵務人員拿著同樣的地址來問路，離開時把紙落在了櫃檯邊。','便條上寫的是「陳先生」，巷名和門牌都與阿川、茶行和印刷行無關。市場裡越傳越大的那段話，到這裡只剩下一件很普通的問路。']}}},
