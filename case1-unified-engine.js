...
var visualMeta={
 ...
 print:{alt:'1958 年臺北印刷行・隔日下午',before:'先看印刷行怎麼運作，不急著追任何一捆紙。',after:'工作桌、鉛字盒與借物簿各有固定位置；後間則比前場更雜，像是所有暫時用不到的東西都先往裡放。',observed:['你先沿著排字桌走了一圈。鉛字盒一格格靠牆排開，紙張按大小壓在桌角，借物簿則壓在玻璃底下。','周老闆收東西很有順序：能歸位的都歸位，暫時說不清用途的才往後間送。要追失頁，得把某一天的流程拆開來看。']},
 market:{alt:'1958 年臺北市場・同日下午',before:'先看人和貨怎麼流動，再決定從哪一攤追紙。',after:'人、貨與包材不停換手；紙一旦進了市場，很快就混進日常交易裡。',observed:['你站在市場口看了一會。菜籃、木箱、秤盤在人群間不斷移動，攤販說話時手也沒停，收錢、找零、包貨幾乎同時進行。','紙在這裡只是眾多耗材之一。真正要找的不是「哪裡有紙」，而是哪一張紙保留了能和阿川冊子對上的特徵。']},
 bookstall:{alt:'1958 年臺北舊書攤・同日下午稍晚',before:'先看看攤位的格局和老闆平常怎麼收書。',after:'書架又深又密，工具書、舊報與零散收購品混在同一個狹窄空間；光靠第一眼很難知道紙被放去了哪裡。',observed:['你沒有立刻翻書，只先把攤位看了一圈。靠街的一側較亮，裡面幾排書架越往下越暗，櫃檯後還堆著尚未分類的收購品。','老闆知道每一類書大概在哪裡，卻不會替零散紙張另外編位置。要找跑腿少年帶來的東西，還是得先問他當時怎麼處理。']}
};
