...
# trust derived flags such as finalReady/finished, evidence/person records, or
# testimony from a witness the player had not legitimately unlocked yet.
...
script_tag = '<script src="case2-engine.js?v=12"></script>'
