...
window.CASE2_RAIN_CANON={
  ...
  people:{
    ...
    landlord:{name:'黃先生',desc:'房東。談租金與房號時記性很好，一提到許月琴卻總把話縮成一句「早就搬了」。租冊上的五月日期是後來補寫的，但他起初不肯說明是誰補的、又為什麼補。'},
    chen:{name:'陳太太',desc:'住得比林秀雲久得多。她記人靠的是日常細節，不太記年份；提起201以前的年輕女房客時，先想起的是姓許、名字裡有個「月」。對最後一次見到月琴，她記得的是雨、樓梯口和兩個陌生背影，而不是日期。'},
    shopkeeper:{name:'吳添福',desc:'永和行老闆。認熟客的方式是先翻帳，再想起人。他對三年前的日期未必張口就來，卻很相信自己留下的賒帳筆跡。'},
    yueqin:{name:'許月琴',desc:'201號前租客。1955年一個雨夜後失去消息。'},
    qiulan:{name:'許秋蘭',desc:'許月琴的妹妹。和姐姐長得很像，卻比照片裡更消瘦。她收到匿名紙條後，一次次回到201門口；既想確認姐姐是否真的留下東西，又不敢在陌生人面前先報出自己的名字。'},
  ...
  actions:{
    ...
    inspect_yonghe_ledger:{gain:'e05',set:{timeline_conflict:true},text:'賒帳簿翻到民國44年6月17日，許月琴的名字還在。洋火一盒、棉線一卷、肥皂一塊——三樣尋常日用品，日期卻比租冊上的「五月搬離」晚了整整一個多月。這個日期值得帶回去再問陳太太，也值得重新攤到房東面前。'},
  ...
  events:{
    qiulan_reveal:{trigger:{all:['e06','e09','e11'],flag:'final_ready'},text:'你把帆布袋帶回201不久，門外又響起三下、停一拍、再兩下。這次女子沒有躲開。她看見袋上的名字，臉色一下變了：「那是我姐姐的。」她說自己叫許秋蘭。幾天前，她收到一張沒有署名的紙條，只寫著「月琴的東西還留在舊住處」。她不知道寄信的人是誰，也不知道對方為什麼現在才找上她；越想越像有人故意把她引回這棟樓。她因此只敢趁雨大、人少的時候過來，也不願先對陌生住戶報出姓名。「第二晚妳問我的時候，我本來想說，可樓梯一有腳步聲，我就走了。」她停了一下，指節在門板上輕敲三下，停一拍，再兩下。「這是我跟姐姐小時候約好的敲法。走到她住過的門前，我每次都會不自覺這樣敲。」她抬起頭：「前幾晚也是我。」',set:{qiulan_revealed:true},know:'qiulan'},
  ...
  ending:{
    correctTitle:'她曾經存在',
    correctText:'你仍不知道許月琴最後去了哪裡。能留下來的，是她確實住過201、六月十七日仍在附近留下賒帳、她的帆布袋後來被保留在樓上，以及陳太太最後一次看見她時，她正和兩名陌生男子一起離開。沒有證據能說明那是不是自願，也沒有人知道兩個男人是誰。秋蘭把姐姐留下的東西抱在懷裡，第一次有人把這段往事完整地說出她的名字。',
    weakTitle:'雨夜怪談',
