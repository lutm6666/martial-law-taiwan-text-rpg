...
window.CASE2_RAIN_CANON={
  ...
  actions:{
    ...
    inspect_bag_contents:{requires:['e09'],gain:'e10',text:'你把帆布袋放平，一樣一樣把東西取出來。沒有密碼本，也沒有什麼異常物件；只有工作手冊、幾封家書、針線、梳子、錢包和幾本普通讀物。這些東西被收得很整齊，生活氣息反而比任何傳聞都更明顯。看起來不像被人倉促丟棄，更像主人原本還打算再回來拿。'},
