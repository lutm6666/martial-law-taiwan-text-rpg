...
var evidence={
 ...
 route_window:{name:'後巷往返時間',type:'現場紀錄',desc:'從雜貨店到林宅後巷最快仍需約四分鐘；若第一夜有人從街口出發並完成後巷往返，時間會非常吃緊。'},
 timing_gap:{name:'第一夜時間缺口',type:'推理紀錄',desc:'人為路線可以解釋部分敲門，但第一夜的外部時間點仍和完整往返所需時間對不上。'}
};
...
var locations={
 ...
 neighbor:{name:'陳太太騎樓',sub:'街坊傳聞',intro:'陳太太一開始堅稱這條巷子「以前就不乾淨」。但當你要求她分清楚「以前聽過什麼」和「最近才有人怎麼說」時，她的版本開始鬆動。',lockedBy:['son_account'],actions:[
  ...
  {id:'gap',name:'把鐘聲與路線時間疊在一起',desc:'檢查同一人是否能完成第一夜行動。',gain:'timing_gap',requires:['bell_time','route_window','source_elder'],text:'把第一夜的鐘聲時間和實際步行路線疊在一起後，若有人要從街口出發、繞到後巷製造敲門再返回，時間明顯不足。這表示第一夜不能直接套用目前觀察到的同一套往返路線。'}]}
};
...
var deductions=[
 ...
 {q:'為什麼第一夜仍然是一個缺口？',opts:[
  ...
  {t:'已知人為路線需要的時間，和第一夜的外部證詞衝突',ok:true,fb:'銅鈴時間與步行時間把第一夜卡住了：目前已知的街口—後巷往返方式無法在這段時間內完成。'},
